          ...
          {pricingPlans.map((plan) => (
            <Card
              ...
              className={cn(
                ...
                plan.highlighted
                  ? 'bg-gradient-to-br from-zinc-900/90 to-zinc-800/90 scale-105 ring-1 ring-[#ccb389]/30 shadow-2xl shadow-[#ccb389]/10'
                  : 'bg-gradient-to-br from-zinc-900/60 to-zinc-800/60 ring-1 ring-zinc-800/50 hover:ring-zinc-700/50'
              )}
              style={
                plan.highlighted
                  ? {
